...
using UnityEngine.Pool;
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        public NetworkObject GetNetworkObject(GameObject prefab, Vector3 position, Quaternion rotation)
        {
            ...
            //Debug.Log("prefap ++" + nonPooledObjects[prefab]);
        ...
        {
            Debug.Log("đang giải phóng");
            m_PooledObjects[prefab].Release(networkObject); //Giải phóng
            nonPooledObjects[prefab]--;
        }

        public void InitializePool()
        {
            if (m_HasInitialized) return; //đã khởi tạo
        ...
        /// </summary>
        private void RegisterPrefabInternal(GameObject prefab, int prewarmCount) // Đăng ký Prefab nội bộ
    {
            ...
            void ActionOnGet(NetworkObject networkObject) //Hành động khi nhận
        {
            ...
            m_PooledObjects[prefab] = new ObjectPool<NetworkObject>
                (CreateFunc, ActionOnGet, ActionOnRelease, ActionOnDestroy, defaultCapacity: prewarmCount);           
        ...
        {
            Debug.Log("số lượng" + nonPooledObjects[prefab]);
